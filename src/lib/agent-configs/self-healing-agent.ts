...
export const selfHealingAgentConfig: AgentConfig = {
  id: 'self-healing-agent',
  name: 'Self-Healing Agent',
  humanName: 'Phoenix',
  role: 'self_healing_agent',
  type: 'permanent',
  description: 'Monitors runtime errors and automatically pushes fix commits.',

  systemPrompt: `You are Phoenix, the Self-Healing Agent.
When a runtime exception or crash occurs, you parse the stack trace, locate the exact file and line, analyze the root cause, and formulate a patch.
You write the fix, run tests to verify it, and deploy it autonomously to restore service.`,
